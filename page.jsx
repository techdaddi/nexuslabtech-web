...
{/* Cursor Effect */}
<div
className=“fixed w-6 h-6 border-2 border-purple-500 rounded-full pointer-events-none z-50 mix-blend-difference transition-transform duration-150”
style={{
    ...
    <div className="max-w-7xl mx-auto px-6 py-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          <img src="https://i.imgur.com/placeholder.png" alt="nexuslabtech" className="h-8" />
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#github" className="text-sm hover:text-purple-400 transition-colors">GitHub</a>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {podcasts.map((podcast, idx) => (
          <div key={idx} className="group p-8 bg-gradient-to-br from-purple-900/10 to-pink-900/10 border border-purple-500/20 rounded-3xl hover:border-purple-500/50 transition-all duration-300">
            ...
            <button className="mt-6 w-full py-3 bg-purple-600/20 hover:bg-purple-600 rounded-full font-semibold transition-all flex items-center justify-center group-hover:shadow-lg group-hover:shadow-purple-500/50">
  ...
  <section id="contacto" className="py-32 px-6 relative overflow-hidden">
    ...
    <div className="max-w-4xl mx-auto text-center relative z-10">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <a href="#" className="px-8 py-4 border-2 border-white rounded-full font-bold hover:bg-white hover:text-black transition-all">
          WhatsApp
        </a>
      </div>
    </div>
  ...
  <footer className="py-12 px-6 border-t border-purple-500/20">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex gap-6">
        <a href="https://github.com/techdaddi" className="text-gray-400 hover:text-purple-400 transition-colors">
          <Github />
        </a>
